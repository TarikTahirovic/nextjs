                    ...
                    <li key={post.id}>
                        <Link
                            href={{
                                ...
                                query: { content: post.content, title: post.title },
                            }}
                            as={`/blog/${post.id}`}
                        >
                            <p>{post.title}</p>
